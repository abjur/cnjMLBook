...
dados %>%
  ...
  knitr::knit_print(align = 'llrr', caption = "Casos novos e casos pendentes por Justiça. Fonte: Justiça em Números.")
```
...
```{r tempo, fig.height=5, fig.cap="Volume de casos novos e pendentes ao longo do tempo nos tribunais de interesse. Fonte: Justiça em Números."}
data(cadmun, package = 'abjData')
cadmun <- distinct(cadmun, uf, regiao)
dados %>%
  filter(justica == 'Estadual', sigla != 'TJ') %>%
...
```{r comparacao, fig.cap="Comparação da quantidade de casos pendentes observada e calculada pela fórmula aproximada, considerando apenas casos de conhecimento de primeiro grau. Fonte: Justiça em Números."}
data(cadmun, package = 'abjData')
cadmun <- distinct(cadmun, uf, regiao)
dados %>% 
  filter(justica == 'Estadual', sigla != 'TJ') %>% 
...
```{r iadn2, fig.cap="IADN ao longo dos anos para os tipos processuais e tribunais de interesse. Fonte: Justiça em Números."}
data(cadmun, package = 'abjData')
cadmun <- distinct(cadmun, uf, regiao)
dados %>% 
  filter(justica == 'Estadual', sigla != 'TJ') %>% 
...
```{r fig:iadn3, fig.cap='IADR calculado para os tribunais da pesquisa considerando diferentes valores de $\\lambda$. Fonte: Justiça em Números.'}
data(cadmun, package = 'abjData')
cadmun <- distinct(cadmun, uf, regiao)
dados_base <- dados %>% 
  filter(justica == 'Estadual', sigla != 'TJ') %>% 
