...
\caption{Metodologia quantitativa. Adaptado de @wickham2016r.}
\label{fig:quanti}
\end{centering}
\end{figure}
...
Não há interesse em estudar a quantidade de casos novos por magistrado ou servidor. As contagens de magistrados e servidores foram fixadas para simplificar
a análise. Também não monitoramos recorribilidade interna por simplicidade.
...
Começamos o estudo com um levantamento baseado no Relatório Justiça em Números (RJN), ano base 2015, que utiliza dados enviados pelos tribunais referentes ao ano de 2015. Essa análise tem como objetivo dar uma visão geral do que estamos enfrentando e quais são os passos.
