...
\section{Códigos utilizados para análise das bases de dados}

\subsection{Produto 2}

\begin{enumerate}
\item \href{https://github.com/abjur/cnjML}{Scripts de análise de dados feitos em R}.
\item \href{https://github.com/abjur/tidyML}{Scripts para arrumar dados dos tribunais}.
\item \href{https://github.com/abjur/tidyPJ}{Scripts para arrumar nomes das empresas}.
\item \href{https://github.com/abjur/tpur}{Pacote em R utilizado para armazenas as TPUs do CNJ}.
\item \href{https://github.com/abjur/tpur}{Pacote em R utilizado para criar a \textit{whitelist} do TJSP e estimar volumes processuais}.
\item \href{https://github.com/courtsbr/esaj}{Scripts de web scraping de tribunais do sistema SAJ}.
\item \href{https://github.com/courtsbr/tjsp}{Scripts de web scraping de diversas páginas do TJSP}.
\item \href{https://github.com/decryptr/}{Modelos para quebrar CAPTCHAs}.
\end{enumerate}

\subsection{Estudo sobre teses da USP}

\begin{enumerate}
\item \href{https://github.com/abjur/esaj}{Pacote em R utilizado para download dos acórdãos}.
\item \href{https://www.dropbox.com/s/kkqlghd5cv10u99/d\_ementas\_2014.rda?dl=0}{Base de dados sobre acórdãos utilizada}.
\item \href{https://github.com/abjur/teses.usp}{Pacote em R utilizado para download das teses da USP}.
\item \href{https://github.com/jtrecenti/teses.usp/raw/master/data/teses\_usp.rda}{Base de dados de teses da USP}.
\end{enumerate}


\section{Eixos de investigação cortados no decorrer da pesquisa}\label{eixos-not}
...
Demandas Repetitivas (IRDR), cujo procedimento é regulado pelos artigo
...
a decidir processos em bloco sem reduzir a segurança jurídica, o aumenta
...
cada dia, considerando todos os agentes do cartório, de forma a
maximizar a
...
modelos similares aos descritos em \citep{Fossaluza2015}. A mensuração da
...
de que o a ordenação de tarefas dentro de uma vara é ineficiente. Um
...
Segundo \citep{CNJ2015}, os processos mais recorrentes do direito do
consumidor são os processos que envolvem danos morais, sendo este um
...
de juízes ``justiceiros'', que arbitram valores de indenização altos o
...
para interposição de recursos, propositura de ação e pratica de outros
...
chamados meios alternativos de solução litígios.
...
A única proposta levantada sobre esse eixo foi a realização de experimentos controlados com a utilização da semana de conciliação. A condução de estudos desse tipo trará maior conhecimento sobre o que explica o fenômeno do acordo e quais os meios fazê-lo acontecer com maior frequência.
...
\section{Anotações das reuniões}\label{reunioes}
...
\item
  ...
  Consumidor.gov. É possível afirmar que o consumidor pode não é o único
...
A terceira grupo focal contou com a presença de Maria Rita Rebello e Ana
...
\item
  ...
  \item
    ...
    ações coletivas.
  \item
    Precisamos entrevistar o MP para falar sobre ações coletivas! Eles
    têm um núcleo do consumidor lá.
  \end{itemize}
\item
  Sobre conciliação
...
\item
  ...
  \item
    As sanções e multas de agências reguladoras podem funcinar como
...
\item
  ...
  \item
    O IRDR não vai funcionar pois os juízes simplesmente vão aplicar o
    que querem e não seguir as ``regras'' de demandas repetitivas.
  \item
...
\item
  ...
  \item
    Problemas de vicio de produto e entrega (logística) são as
...
\section{Códigos para lidar com incorporações}\label{codpj}
...
\section{Códigos para filtrar pessoas físicas e jurídicas}\label{codpfpj}
