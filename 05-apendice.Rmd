...
1. [Pacote em R utilizado para armazenar as TPUs do CNJ](https://github.com/abjur/tpur).
...
partes da demanda, pela Defensoria Pública ou Ministério Público. Quando
...
dos problemas do consumidor que o índice ataca. Para ser efetivo, o IRDR
...
n.º 13.256/2016 e acrescentou a palavra ``preferencialmente'' aos
...
Esse é um argumento particularmente plausível no caso dos JECs por conta
...
sucesso é baixa, litigar é um ato vantajoso para o autor, mesmo que o mesmo
não tenha razão.
...
apenas em casos extremos; iii) ainda que o magistrado afaste a
...
possivelmente para pesquisas futuras.
...
A única proposta levantada sobre esse eixo foi a realização de experimentos controlados com a utilização da semana de conciliação. A condução de estudos desse tipo trará maior conhecimento sobre o que explica o fenômeno do acordo e quais as formas de aumentar a frequencia desses acordos.
...
1. Estratégia processual.
    ...
    1. Sob quais circunstâncias a empresa recorre de uma decisão? (1ª e 2ª
    instância?)
...
1. O superendividamento é um problema corrente nos canais do portal
  Consumidor.gov.br. É possível afirmar que o consumidor não é o único
...
1. Sobre ações coletivas
    ...
    canais Procon, Reclame Aqui, Consumidor.gov.br e Judiciário e
...
1. Sobre fila de trabalho nos processos
    ...
    facilitar comunicação (e.g.informar sobre um
...
1. Mecanismos de composição extrajudicial
    ...
    Consumidor.gov.br e Reclame Aqui, o juíz não dá indenização por dano
