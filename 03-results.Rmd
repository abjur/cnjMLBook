...
Similar ao identificado em São Paulo, a empresa com maior número de processos no Mato Grosso foi uma instituição bancária. Nesse estado, o grupo de empresas relacionado ao Banco Bradesco concentra `r maiores_litigantes_tjmt$p[1]` dos litígios. Logo em seguida, diferente do que ocorre com os procesoss paulistas, vem a companhia de telefonia Claro, com `r maiores_litigantes_tjmt$p[2]` dos processos. As outras grandes companhias de telefonia também se destacam nas 10 primeiras posições, nas posições 4,5 e 10.
...
O outro destaque foi a seguradora Líder, admnistradora do seguro DPVAT, como 3,26% dos litígios. Esta empresa não aparece na lista dos outros tribunais e, como uma outra dissonância, também notou-se a ausência de empresas admnistradoras de cadastro de inadimplentes nas 30 maiores também destoa do observado em outros tribunais.
...
A sexta causa de pedir mais comum contra instituições bancárias envolve Indenizações por Danos Materiais, com `r assuntos_bancos$p[5]` dos litígios. Segundo a TPU, esse assunto é uma especialização da classificação geral "Responsabilidade do Fornecedor", que figura como a oitava posição no rankeamento dos assuntos mais comuns, com `r assuntos_bancos$p[8]` dos processos.
...
No segmento das telecomonucações, as 4 maiores companhias de telefonia do Brasil concemtram mais de 90% dos processos. Se considerarmos ainda as operadoras de televisão, esse número sobe para 98,9%.
...
Os processos contra empresas de seguros são polarizados, as duas maiores demandadas são a Porto Seguro e a seguradora Líder, com 48,7% e 30,8% dos litígios, respectivamente. Desconsiderando essas intituições, observa-se uma pulverização dos processos detre as demais seguradoras.
...
Com relação aos assuntos, por outro lado, não há pulverização. 87,3% dos cassos são processos denominados "Seguro", enquanto 10,9% dos processos discutem indenizações por danos morais e materiais, totalizando assim 98,3% dos processos.
...
A sexta causa mais frequente dos processos contra instituições bancárias é a classficação "Abatimento proporcional do preço", com `r assuntos_bancos$p[6]` dos casos. Essa posição do ranking delimita uma mudança na distribuição dos processos: a partir deste assunto, as próximas causas de pedir não passam de de 3%.
...
Juntas, as dez maiores causas de pedir contra instituições financeiras abarcam mais de 90% dos litígios contra bancos e instituições finceiras.
...
No segmento das telecomonucações, as maiores 4 empresas de telefonia concentram mais de 85% dos processos. Se considerarmos ainda as operadoras de televisão, esse número sobe para 97,2%.
...
No grupo de processos específicos sobre os serviçõs prestados, 7,9% deles foram classificados no assunto "Transporte Aéreo", uma classificação genéria das TPU's, que abarcam processos sobre acidentes aéreos, atrasos de voos, cancelamentos de voos, extravios de bagagem e overbooking. Essa classificações mais específicas aparecem nas posições seguintes no raking, sendo os acidentes aéreos as causas de pedir mais frequentes, com 4,7% dos casos. Logo em seguida tem-se os atrasos de voos, com 4,2% dos casos, seguido de perto pelos cancelamentos, com 3,7% dos processos e extravios de bagagem com 2,7%.
...
Realizando a mesma análise para os demais setores, conclui-se que a estabilidade é um traço comum das curvas de volumes processuais dos maiores litigantes da Bahia. A única exceção à regra está nos processos contra bancos e demais instituições financeiras, que apresentam um declinío na quantidade semestral de processos entre 2013 e 2015.
